...
func FlyURL() string {
	return "https://mochammadnaufalrizki-final-project-be2908924.fly.dev" // TODO: replace this
}

func main() {
	os.Setenv("DATABASE_URL", "postgres://postgres:Nero_Cld65@localhost:5432/final_project_web_application")
...
func RunServer(db *gorm.DB, mux *http.ServeMux) *http.ServeMux {
	...
	MuxRoute(mux, "PUT", "/api/v1/tasks/update/category", middleware.Put(middleware.Auth(http.HandlerFunc(apiHandler.TaskAPIHandler.UpdateTaskCategory))), "?task_id=", "?category_id=")

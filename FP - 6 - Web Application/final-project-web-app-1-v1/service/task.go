...
type TaskService interface {
	...
	GetTaskByCategoryID(ctx context.Context, id int) ([]entity.Task, error)
...
func (s *taskService) GetTaskByCategoryID(ctx context.Context, id int) ([]entity.Task, error) {
	return s.taskRepo.GetTasksByCategoryID(ctx, id)
}
